...
## **Validación del fungicida Benzovindiflupyr + Azoxystrobin (ELATUS), para el control de roya del cafeto en variedad Caturra**

### ***Resumen***

La Roya del Cafeto (Hemileia vastatrix) es la enfermedad de mayor importancia económica para el cultivo del café en el mundo, que causa pérdidas en la producción en variedades susceptibles sin control entre el 23 al 50% en Colombia y hasta el 80% en otros países. De las casi 850.000 ha sembradas en café en Colombia, aún queda un 16% del área sembrada en variedades susceptibles a la roya, que requieren manejo, principalmente mediante la aplicación de fungicidas de síntesis química. Teniendo en cuenta que son pocas los productos fungicidas investigados y recomendados por Cenicafé para el control de la roya dentro de la oferta del mercado, y que por normatividad, regulación, sanidad, inocuidad o condiciones del mercado nacional e internacional muchos de los agroquímicos están siendo restringidos o limitados, entre ellos los recomendados o disponibles para el control de la roya, se requiere por parte de la industria modificar productos existentes y desarrollar nuevas alternativas para el control, que puedan evaluarse y validarse en Cenicafé para los caficultores colombianos. Por tanto, este experimento busca validar el producto Benzovindiflupyr + Azoxystrobin (ELATUS®, Syngenta) como nueva alternativa para control de la roya en Colombia, basado en resultados previos y recomendaciones del fabricante. Esta validación se realizará en la Estación Experimental La Catalina de Cenicafé (Pereira, Risaralda) a 1.321m.s.n.m., en un cultivo de variedad Caturra de segunda zoca, de 19 meses de edad, en el cual se realizarán 3 aplicaciones del fungicida en dosis de 0.4kg/ha a 60, 105 y 165 días después de floración principal. Se evaluará Incidencia, severidad y defoliación causada por la roya, y los efectos en la producción de café cereza, su conversión a café pergamino seco y café verde, y la calidad física obtenida. Se validará durante la cosecha de mitaca de primer semestre de 2022 y cosecha principal del segundo semestre de 2022, comparando respecto a un testigo relativo de fungicida ya recomendado con 3 aplicaciones, y a un testigo absoluto sin aplicación. Se espera generar resultados que soporten la recomendación de un nuevo fungicida para el control de roya del cafeto en Colombia por parte del Servicio de Extensión de la FNC y sea usado por los caficultores, y así evitar epidemias severas y pérdidas en la producción y calidad por esta enfermedad.
...
Validar el fungicida Benzovindiflupyr + Azoxystrobin (ELATUS®), para el control de roya del cafeto en variedad Caturra.
